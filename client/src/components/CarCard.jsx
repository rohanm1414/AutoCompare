    ...
    <div className="card group hover:shadow-md transition-shadow duration-200">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-sm text-gray-600 mb-4">
          ...
          <div className="text-center bg-gray-50 rounded-lg p-2">
            <div className="font-semibold text-gray-900">{car.specs.mpgCombined || car.specs.range + 'mi'}</div>
            <div className="text-xs">{car.specs.fuelType === 'Electric' ? 'Range' : 'MPG'}</div>
          </div>
          <div className="text-center bg-gray-50 rounded-lg p-2">
        ...
        <div className="flex items-center justify-between">
          <div>
            <span className="text-blue-600 font-bold text-lg">${car.price.base.toLocaleString()}</span>
